...
define('SHIP_PATH', '/var/www/vhosts/flashxhype.com/wp-content/plugins/shipping-labels/ship-master/libs');

// configuration options for all shippers
$config = array();
// true for production or false for development
$config['production_status'] = true; 
...
// shipping vendor
$config['email_tracking_number_to_receiver'] = false; 
    

// shipper information
$config['shipper_name'] = 'FlashXHype'; 
$config['shipper_attention_name'] = 'Shipping Dept'; 
$config['shipper_phone'] = ''; 
$config['shipper_email'] = 'returns@flashxhype.com';
$config['shipper_address1'] = '9960 Glenoaks Blvd.'; 
$config['shipper_address2'] = 'Suite C';
$config['shipper_address3'] = ''; 
$config['shipper_city'] = 'Sun Valley';
$config['shipper_state'] = 'CA'; 
$config['shipper_postal_code'] = '91352'; 
...
$config['ups'] = array();
$config['ups']['key'] = 'DCC2F841CA60BDA2';
$config['ups']['user'] = 'arsenal43';
$config['ups']['password'] = 'Rastamonster123';
$config['ups']['account_number'] = '2766WW';
